...
EOF_FOREIGN
    ...
    error_msg="the step reported success but wrote outside its own spec folder in the specs repo — $foreign_named — those changes were discarded. A step writes only $spec_folder/; press Run again for this step."
