...
#
# Before them it installs what they need and cannot install themselves:
# mise and a node, and Claude Code (signing in to it is left to you).
#
...
install_prerequisites || status=1
