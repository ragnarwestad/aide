...
Context7 is an MCP server from Upstash that gives Gemini access to **up-to-date, version-specific documentation** for libraries and frameworks.
...
The script offers to add Context7 MCP automatically.
...
**Restart Gemini** to load the MCP server.
