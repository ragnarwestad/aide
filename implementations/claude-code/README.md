...
**If not set:** Reports are written to `aide/reports/` (default, gitignored)
...
4. **Claude will automatically:**
   - Create the document structure: `../aide/reports/<NN>-PROJ-7637-slug/`
...
6. **Read the documentation:**
   ```bash
   cat ../aide/reports/<NN>-PROJ-7637-slug/2-analysis.md
   cat ../aide/reports/<NN>-PROJ-7637-slug/3-solution.md
   ```
...
cat ../aide/reports/<NN>-PROJ-7890-slug/2-analysis.md
cat ../aide/reports/<NN>-PROJ-7890-slug/3-solution.md
...
# Open the PDF
open ../aide/reports/<NN>-PROJ-7890-slug/PROJ-7890.pdf
```
