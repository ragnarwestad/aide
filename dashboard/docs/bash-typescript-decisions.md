...
| The status-mark rule — which Status cells count as done                                                                                                      | `total_progress_for` in `aide-run-spec`                                       | `isDoneMark` in `dashboard/src/project/parse-status/index.ts`                                                             | `tests/fixtures/status-row-counting.json`                                                                                                                                                          |
