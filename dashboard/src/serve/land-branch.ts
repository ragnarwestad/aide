...
// descriptions), duration.ts (stampTotalDuration, spec 207) and
// freshness.ts (withFreshness, specs 97/154). Kept as a barrel at this
// path because setup-land.ts imports from it.
...
export { stampTotalDuration } from "./land-branch/duration.ts";
