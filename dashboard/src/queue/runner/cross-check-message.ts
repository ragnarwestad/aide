...
/** The bash cross-check's verdicts (run-spec-status-line.sh) — a step
 *  that made `no-progress`, or an archive that left its open merge
 *  unfinished — as the board's own message for the step it was about,
