...
/* The generic ".specform .factions" gap (var(--sp-1), 4px) reads as the
   Save button sitting on top of the checklist's last row — this form's
   list is taller and denser than the other specforms that rule serves. */
.checks .factions { margin-top: var(--sp-3); }
...
.proj-row { background: var(--surface); border: 1px solid var(--line);
  ...
  display: flex; align-items: center; gap: var(--sp-4); position: relative; }
