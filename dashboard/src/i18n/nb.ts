...
export const nb: Record<TranslationKey, string> = {
  ...
  "list.pushError": "Et stegs push nådde ikke origin. Hent ned grenen lokalt, og push den på nytt.",
  "list.prError": "Det kunne ikke opprettes en pull-forespørsel for denne grenen. Opprett en for hånd.",
  "list.branchLeftBehind":
    "Denne spesifikasjonen ble slått sammen, men grenen kunne ikke slettes på origin. " +
    "Slett den for hånd.",
  "list.noPullRequestOpened": "koden ligger på en gren, og det ble ikke opprettet noen pull-forespørsel for den",
